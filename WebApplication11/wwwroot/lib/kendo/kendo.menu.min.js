...
!function (e, define) { define("kendo.menu.min", ["kendo.popup.min"], e); }(function () { return function (e, t) { function n(e, t) { return e = e.split(" ")[!t + 0] || e, e.replace("top", "up").replace("bottom", "down"); } function i(e, t, n) { e = e.split(" ")[!t + 0] || e; var i = { origin: ["bottom", n ? "right" : "left"], position: ["top", n ? "right" : "left"] }, r = /left|right/.test(e); return r ? (i.origin = ["top", e], i.position[1] = m.directions[e].reverse) : (i.origin[0] = e, i.position[0] = m.directions[e].reverse), i.origin = i.origin.join(" "), i.position = i.position.join(" "), i; } function r(t, n) { try {
    ...
    return !1;
        ...
        c = c.parentNode; if (!e(c).is(pe)) {
        if (h.hasClass(Q))
            return n.preventDefault(), t;
        if (n.handled || !s._triggerSelect(l, f) || u || n.preventDefault(), n.handled = !0, r = h.children(ne), o = r.is(":visible"), a.closeOnClick && (!_ || C) && (!r.length || y))
            return h.removeClass(Z).css("height"), s._oldHoverItem = s._findRootParent(h), s.close(d.parentsUntil(s.element, ie)), s.clicked = !1, "MSPointerUp".indexOf(n.type) != -1 && n.preventDefault(), t;
        _ && n.enterKey && d[0].click(), (s._isRootItem(h) && a.openOnClick || m.support.touch || (G || W) && s._isRootItem(h.closest(ie))) && (_ || u || w || n.preventDefault(), s.clicked = !0, i = r.is(":visible") ? D : H, (a.closeOnClick || i != D) && s[i](h));
    } }, _triggerSelect: function (e, t) { var n, i, r, o = e.data("selectHandler"); return o && (n = this._getEventData(e), o.call(this, n)), i = n && n.isDefaultPrevented(), r = this._triggerEvent({ item: t, type: z }), i || r; }, _getEventData: function (e) { var t = { sender: this, target: e, _defaultPrevented: !1, preventDefault: function () { this._defaultPrevented = !0; }, isDefaultPrevented: function () { return this._defaultPrevented; } }; return t; }, _documentClick: function (e) { r(this.element[0], e.target) || (this.clicked = !1); }, _focus: function (n) { var i = this, r = n.target, o = i._hoverItem(), s = f(); return r == i.wrapper[0] || e(r).is(":kendoFocusable") ? (s === n.currentTarget && (o.length ? i._moveHover([], o) : i._oldHoverItem || i._moveHover([], i.wrapper.children().first())), t) : (n.stopPropagation(), e(r).closest(".k-content").closest(".k-menu-group").closest(".k-item").addClass($), i.wrapper.focus(), t); }, _keydown: function (e) { var n, i, r, o = this, s = e.keyCode, a = o._oldHoverItem, l = m.support.isRtl(o.wrapper); if (e.target == e.currentTarget || s == b.ESC) {
        if (a || (a = o._oldHoverItem = o._hoverItem()), i = o._itemBelongsToVertival(a), r = o._itemHasChildren(a), s == b.RIGHT)
            n = o[l ? "_itemLeft" : "_itemRight"](a, i, r);
        else if (s == b.LEFT)
            n = o[l ? "_itemRight" : "_itemLeft"](a, i, r);
        else if (s == b.DOWN)
            n = o._itemDown(a, i, r);
        else if (s == b.UP)
            n = o._itemUp(a, i, r);
