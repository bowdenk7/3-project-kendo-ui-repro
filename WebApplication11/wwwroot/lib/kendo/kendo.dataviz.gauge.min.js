...
!function (e, define) { define("util/text-metrics.min", ["kendo.core.min"], e); }(function () { !function (e) { function n(e) { var n, t = []; for (n in e)
    ...
    t += (t << 1) + (t << 4) + (t << 7) + (t << 8) + (t << 24), t ^= e.charCodeAt(n); return t >>> 0; } function i() { return { width: 0, height: 0, baseline: 0 }; } function o(e, n, t) { return l.current.measure(e, n, t); } var r, a, s, l; window.kendo.util = window.kendo.util || {}, r = kendo.Class.extend({ init: function (e) { this._size = e, this._length = 0, this._map = {}; }, put: function (e, n) { var t = this._map, i = { key: e, value: n }; t[e] = i, this._head ? (this._tail.newer = i, i.older = this._tail, this._tail = i) : this._head = this._tail = i, this._length >= this._size ? (t[this._head.key] = null, this._head = this._head.newer, this._head.older = null) : this._length++; }, get: function (e) { var n = this._map[e]; if (n)
        ...
        for (e = i.getRangeRadius(), i.options.labels.position === W && (e += r + a), n = e + r / 2, t = 0; t < o.length; t++)
            o[t]._geometry.setRadiusX(n).setRadiusY(n);
        i.bbox = j.union(i.bbox, i.ranges.bbox());
    } }, renderRanges: function () { var e, n, t, i, o, r, a = this, s = a.arc, l = new S, c = a.rangeSegments(), p = c.length, d = a.options.reverse, u = a.options.rangeSize, h = a.options.rangeDistance; if (p)
        for (i = a.getRangeRadius(), a.radius(a.radius() - u - h), r = 0; r < p; r++)
            t = c[r], e = a.slotAngle(t[d ? "to" : "from"]), n = a.slotAngle(t[d ? "from" : "to"]), n - e !== 0 && (o = new A.Arc(s.center, { radiusX: i + u / 2, radiusY: i + u / 2, startAngle: e, endAngle: n }), l.append(new T.Arc(o, { stroke: { width: u, color: t.color, opacity: t.opacity } }))); return l; }, rangeSegments: function () { function e(e, n, t, i) { return { from: e, to: n, color: t, opacity: i }; } var n, t, o, r, a, s = this, l = s.options, c = l.ranges || [], p = c.length, d = l.rangePlaceholderColor, u = [], h = l.min, f = l.max; if (p)
        for (u.push(e(h, f, d)), r = 0; r < p; r++)
            for (n = i(c[r], h, f), t = u.length, a = 0; a < t; a++)
                if (o = u[a], o.from <= n.from && n.from <= o.to) {
                    u.push(e(n.from, n.to, n.color, n.opacity)), o.from <= n.to && n.to <= o.to && u.push(e(n.to, o.to, d, n.opacity)), o.to = n.from;
                    break;
                } return u; }, getRangeRadius: function () { var e, n = this, t = n.options, i = t.majorTicks.size, o = t.rangeSize, r = t.rangeDistance, a = n.arc; return e = t.labels.position === Z ? a.getRadiusX() - i - r - o : a.getRadiusX() - o; }, renderArc: function (e, n) { var t = this, i = t.options, o = t.arc = new A.Arc(e, { radiusX: n, radiusY: n, startAngle: i.startAngle + Q, endAngle: i.endAngle + Q }); return o; }, renderTicks: function () { function e(e, n, t, i) { var o, r, a, s = new S, l = e.center, c = e.getRadiusX(), p = i.visible; if (p)
        for (o = 0; o < n.length; o++)
            r = e.pointAt(n[o]), a = new z(l.x + c - i.size, l.y).rotate(n[o], l), s.append(new R({ stroke: { color: i.color, width: i.width } }).moveTo(r).lineTo(a)); return s; } var n = this, t = n.arc, i = n.options, o = i.labels.position, r = new S, a = i.majorTicks.size, s = i.minorTicks.size, l = t.clone(), c = l.getRadiusX(); return n.majorTickAngles = n.tickAngles(t, i.majorUnit), n.majorTicks = e(l, n.majorTickAngles, i.majorUnit, i.majorTicks), r.append(n.majorTicks), n._tickDifference = a - s, o === Z && l.setRadiusX(c - a + s).setRadiusY(c - a + s), n.minorTickAngles = n.normalizeTickAngles(n.tickAngles(t, i.minorUnit)), n.minorTicks = e(l, n.minorTickAngles, i.minorUnit, i.minorTicks, i.majorUnit), r.append(n.minorTicks), r; }, normalizeTickAngles: function (e) { var n, t = this, i = t.options, o = i.majorUnit / i.minorUnit; for (n = e.length - 1; n >= 0; n--)
        n % o === 0 && e.splice(n, 1); return e; }, tickAngles: function (e, n) { var t, i = this, o = i.options, r = o.reverse, a = o.max - o.min, s = e.endAngle - e.startAngle, l = e.startAngle, c = a / n, p = s / c, d = []; for (r && (l += s, p = -p), t = 0; t < c; t++)
        d.push(_(l, V)), l += p; return _(l) <= e.endAngle && d.push(l), d; }, radius: function (e) { var t = this; return e ? (t.arc.setRadiusX(e).setRadiusY(e), t.repositionTicks(t.majorTicks.children, t.majorTickAngles), t.repositionTicks(t.minorTicks.children, t.minorTickAngles, !0), n) : t.arc.getRadiusX(); }, repositionTicks: function (e, n, t) { var i, o, r, a, s, l = this, c = t ? l._tickDifference || 0 : 0, p = l.arc, d = p.getRadiusX(); for (t && l.options.labels.position === Z && 0 !== c && (p = l.arc.clone(), p.setRadiusX(d - c).setRadiusY(d - c)), i = 0; i < e.length; i++)
        o = p.pointAt(n[i]), r = e[i].segments, a = o.x - r[0].anchor().x, s = o.y - r[0].anchor().y, e[i].transform((new A.Transformation).translate(a, s)); } }), re = p.extend({ init: function (n, t) { var i, o, r, a, s, l = this, h = u.ui.themes || {}; if (c.destroy(n), e(n).empty(), p.fn.init.call(l, n), l.wrapper = l.element, l._originalOptions = d({}, t), i = d({}, l.options, t), r = i.theme, a = h[r] || h[r.toLowerCase()], o = r && a ? a.gauge : {}, l.options = d({}, o, i), e.isArray(i.pointer))
        for (s = 0; s < i.pointer.length; s++)
            l.options.pointer[s] = d({}, o.pointer, i.pointer[s]); l.element.addClass("k-gauge"), l.surface = l._createSurface(), l.redraw(); }, options: { plotArea: {}, theme: "default", renderAs: "", pointer: {}, scale: {}, gaugeArea: {} }, destroy: function () { this.surface.destroy(), p.fn.destroy.call(this); }, value: function (e) { var t = this, i = t.pointers[0]; return 0 === arguments.length ? i.value() : (i.value(e), t._setValueOptions(e), n); }, _draw: function () { var e = this.surface; e.clear(), e.draw(this._visuals); }, exportVisual: function () { return this._visuals; }, allValues: function (n) { var t, i = this, o = i.pointers, r = []; if (0 === arguments.length) {
        for (t = 0; t < o.length; t++)
            r.push(o[t].value());
        return r;
    } if (e.isArray(n))
        for (t = 0; t < n.length; t++)
            b(n[t]) && o[t].value(n[t]); i._setValueOptions(n); }, _setValueOptions: function (e) { var n, t = [].concat(this.options.pointer); for (e = [].concat(e), n = 0; n < e.length; n++)
        t[n].value = e[n]; }, _resize: function () { var e, n = this, t = n.options.transitions; for (n.options.transitions = !1, e = 0; e < n.pointers.length; e++)
        n.pointers[e].options.animation.transitions = !1; for (n.redraw(), n.options.transitions = t, e = 0; e < n.pointers.length; e++)
        n.pointers[e].options.animation.transitions = t; }, redraw: function () { var e, n = this, t = d(n._getSize(), n.options.gaugeArea), i = new j([0, 0], [t.width, t.height]); n.surface.clear(), n.gaugeArea = n._createGaugeArea(), n.surface.element.css({ width: t.width, height: t.height }), n._createModel(), e = r(i.bbox(), n._gaugeAreaMargin), n.reflow(e); }, _createGaugeArea: function () { var e, n = this, t = n.options.gaugeArea, i = n.surface.size(), o = t.border || {}, a = new j([0, 0], [i.width, i.height]); return n._gaugeAreaMargin = t.margin || J, o.width > 0 && (a = r(a, o.width)), e = R.fromRect(a, { stroke: { color: o.width ? o.color : "", width: o.width, dashType: o.dashType, lineJoin: "round", lineCap: "round" }, fill: { color: t.background } }); }, _createSurface: function () { var n, t = this, i = t.options, o = t._getSize(); return o = i.gaugeArea ? d(o, i.gaugeArea) : o, n = e("<div></div>").appendTo(t.element).css({ width: o.width, height: o.height }), new T.Surface.create(n, { type: i.renderAs }); }, getSize: function () { return this._getSize(); }, _getSize: function () { var e = this, n = e.element, t = n.width(), i = n.height(); return t || (t = G), i || (i = Y), { width: t, height: i }; } }), ae = re.extend({ init: function (e, n) { var t = this; re.fn.init.call(t, e, n), c.notify(t, u.ui); }, options: { name: "RadialGauge", transitions: !0, gaugeArea: { background: "" } }, reflow: function (e) { var n, t = this, i = t.pointers; for (t.scale.reflow(e), t._initialPlotArea = t.scale.bbox, n = 0; n < i.length; n++)
        i[n].reflow(t.scale.arc), t._initialPlotArea = j.union(t._initialPlotArea, i[n].bbox); t.fitScale(e), t.alignScale(e), t._buildVisual(t.gaugeArea, i, t.scale), t._draw(); }, _buildVisual: function (e, n, t) { var i, o, r = new S; for (r.append(e), r.append(t.ticks), r.append(t.ranges), o = 0; o < n.length; o++)
        i = n[o], i.render(), r.append(i.elements), i.value(i.options.value); r.append(t.labelElements), this._visuals = r; }, fitScale: function (e) { for (var n, t, i, o, r, a = this, s = a.scale, c = s.arc, p = a._initialPlotArea, d = l.abs(a.getDiff(p, e)), u = _(d, V), h = _(-d, V), f = 0, g = 0; !(!(g++ < 100) || (f = r === i ? f + 1 : 0, f > 5) || u != o && (n = a.getPlotBox(u, e, c), 0 <= n && n <= 2) || h != o && (i = a.getPlotBox(h, e, c), 0 <= i && i <= 2) || (o = n > 0 && i > 0 ? 2 * u : n < 0 && i < 0 ? 2 * h : _((u + h) / 2 || 1, V), t = a.getPlotBox(o, e, c), 0 <= t && t <= 2));)
        r = i, t > 0 ? (h = o, i = t) : (u = o, n = t); }, getPlotBox: function (e, n, t) { var i, o = this, r = o.scale, a = o.pointers, s = t.getRadiusX(); for (t = t.clone(), t.setRadiusX(s + e).setRadiusY(s + e), r.arc = t, r.reflow(n), o.plotBbox = r.bbox, i = 0; i < a.length; i++)
        a[i].reflow(t), o.plotBbox = j.union(o.plotBbox, a[i].bbox); return o.getDiff(o.plotBbox, n); }, getDiff: function (e, n) { return l.min(n.width() - e.width(), n.height() - e.height()); }, alignScale: function (e) { var n, t = this, i = t.plotBbox.center(), o = e.center(), r = i.x - o.x, a = i.y - o.y, s = t.scale, l = t.pointers; for (s.arc.center.x -= r, s.arc.center.y -= a, s.reflow(e), n = 0; n < l.length; n++)
        l[n].reflow(s.arc), t.plotBbox = j.union(s.bbox, l[n].bbox); }, _createModel: function () { var n, t, i = this, o = i.options, r = o.pointer, a = i.scale = new oe(o.scale); for (i.pointers = [], r = e.isArray(r) ? r : [r], t = 0; t < r.length; t++)
        n = new ie(a, d({}, r[t], { animation: { transitions: o.transitions } })), i.pointers.push(n); } }), se = re.extend({ init: function (e, n) { var t = this; re.fn.init.call(t, e, n), c.notify(t, u.ui); }, options: { name: "LinearGauge", transitions: !0, gaugeArea: { background: "" }, scale: { vertical: !0 } }, reflow: function (e) { var n, t = this, i = t.pointers, o = e.origin.x, r = e.origin.y, a = new u.Box2D(o, r, o + e.width(), r + e.height()); for (t.scale.reflow(a), n = 0; n < i.length; n++)
        i[n].reflow(); t.bbox = t._getBox(a), t._alignElements(), t._shrinkElements(), t._buildVisual(), t._draw(); }, _buildVisual: function () { var e, n, t = this, i = new S, o = t.scale.render(), r = t.pointers; for (i.append(t.gaugeArea), i.append(o), n = 0; n < r.length; n++)
        e = r[n], i.append(e.render()), e.value(e.options.value); t._visuals = i; }, _createModel: function () { var n, t, i, o = this, r = o.options, a = r.pointer, s = o.scale = new le(r.scale); for (o.pointers = [], a = e.isArray(a) ? a : [a], i = 0; i < a.length; i++)
        ...
        s.wrap(r[t].box.clone()); return o.options.vertical ? (n = s.width() / 2, s = new w(a.x - n, e.y1, a.x + n, e.y2)) : (n = s.height() / 2, s = new w(e.x1, a.y - n, e.x2, a.y + n)), s; }, _alignElements: function () { var e, n, t = this, i = t.scale, o = t.pointers, r = i.box, a = o[0].box.clone().wrap(i.box), s = t.bbox; for (n = 0; n < o.length; n++)
        a.wrap(o[n].box.clone()); for (i.options.vertical ? (e = s.center().x - a.center().x, i.reflow(new w(r.x1 + e, s.y1, r.x2 + e, s.y2))) : (e = s.center().y - a.center().y, i.reflow(new w(s.x1, r.y1 + e, s.x2, r.y2 + e))), n = 0; n < o.length; n++)
        o[n].reflow(t.bbox); }, _shrinkElements: function () { var e, n = this, t = n.scale, i = n.pointers, o = t.box.clone(), r = t.options.vertical ? "y" : "x", a = i[0].box; for (e = 0; e < i.length; e++)
        a.wrap(i[e].box.clone()); for (o[r + 1] += l.max(o[r + 1] - a[r + 1], 0), o[r + 2] -= l.max(a[r + 2] - o[r + 2], 0), t.reflow(o), e = 0; e < i.length; e++)
        i[e].reflow(n.bbox); } }), le = g.extend({ init: function (e) { var n = this; n.options = d({}, n.options, e), n.options = d({}, n.options, { labels: { mirror: n.options.mirror } }), n.options.majorUnit = n.options.majorUnit || h(n.options.min, n.options.max), m.fn.init.call(n, n.options), n.options.minorUnit = n.options.minorUnit || n.options.majorUnit / 10; }, options: { min: 0, max: 50, majorTicks: { size: 15, align: W, color: M, width: N, visible: !0 }, minorTicks: { size: 10, align: W, color: M, width: N, visible: !0 }, line: { width: N }, labels: { position: W, padding: 2 }, mirror: !1, _alignLines: !1 }, render: function () { var e = this, n = e.elements = new S, t = e.renderLabels(), i = e.renderLine(), o = e.renderTicks(), r = e.renderRanges(); return n.append(i, t, o, r), n; }, renderRanges: function () { var e, n, t, o, r, a = this, s = a.options, l = s.min, c = s.max, p = s.ranges || [], d = s.vertical, u = s.labels.mirror, h = new S, f = p.length, g = s.rangeSize || s.minorTicks.size / 2; if (f)
        for (r = 0; r < f; r++)
            e = i(p[r], l, c), n = a.getSlot(e.from, e.to), t = d ? a.lineBox() : n, o = d ? n : a.lineBox(), d ? t.x1 -= g * (u ? -1 : 1) : o.y2 += g * (u ? -1 : 1), h.append(R.fromRect(new j([t.x1, o.y1], [t.x2 - t.x1, o.y2 - o.y1]), { fill: { color: e.color, opacity: e.opacity }, stroke: {} })); return h; }, renderLabels: function () { var e, n = this, i = n.options, o = n.labels, r = new S; for (e = 0; e < o.length; e++)
        r.append(t(o[e], i.labels)); return r; }, renderLine: function () { var e, n = this, t = n.options, i = t.line, o = n.lineBox(), r = new S; return i.width > 0 && i.visible && (e = new R({ stroke: { color: i.color, dashType: i.dashType, width: i.width } }), e.moveTo(o.x1, o.y1).lineTo(o.x2, o.y2), r.append(e)), r; }, renderTicks: function () { function e(e, i) { var a, l = e.length; if (i.visible)
        for (a = i.skip; a < l; a += i.step)
